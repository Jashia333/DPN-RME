...
class Autoencoder(torch.nn.Module):
    ...
    def fit(self, train_dl, optimizer, epochs=100):
        for epoch in range(epochs):
            ...
            for i, data in enumerate(train_dl):
                ...
                t2_y_point_pred = self.forward(aug_output)

                loss_ = torch.sqrt(torch.nn.functional.mse_loss(t_y_point * t_y_mask, t2_y_point_pred * t_y_mask).to(torch.float32))
